...
def parse_fn(example):
    ...
    features = {
        ...
        'input_ua': tf.io.FixedLenFeature([], tf.string), 'input_va': tf.io.FixedLenFeature([], tf.string),
        'output_sst': tf.io.FixedLenFeature([], tf.string), 'output_t300': tf.io.FixedLenFeature([], tf.string),
        'output_ua': tf.io.FixedLenFeature([], tf.string), 'output_va': tf.io.FixedLenFeature([], tf.string)}
