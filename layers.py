...
class Embedding(tf.keras.layers.Layer):
    def __init__(self, num_predictor, seq_len, encode_phase):
        ...
        self.convblock1 = ConvMaxPoolBlock(filters=4, kernel_size=3, pool_size=2, strides=2, t=seq_len, h=12, w=36, c=4) # here t used only in encoder
        self.convblock2 = ConvMaxPoolBlock(filters=8, kernel_size=3, pool_size=2, strides=2, t=seq_len, h=6, w=18, c=8)
...
class Restore(tf.keras.layers.Layer):
    def __init__(self, num_predictor):
        ...
        self.reshape = tf.keras.layers.Reshape((-1, 6, 18, 8, self.num_predictor))
